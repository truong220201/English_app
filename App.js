...
//
import speech from './app/screens/speech';
import speechadd from './app/screens/speechadd';
import speechadde from './app/screens/speechadde';
    ...
    return (
      <NavigationContainer>
        <Stack.Navigator  initialRouteName="front" screenOptions={{headerShown: true}}>
          ...
          <Stack.Screen name = "speechadde" component = {speechadde}  options={{headerShown: true,title:'',headerTransparent:true,headerShadowVisible:false,headerTintColor:'white'}} />
          ...
          <Stack.Screen name = "speechword" component = {speechword}  options={{headerShown: true,title:'',headerTransparent:true,headerShadowVisible:false,headerTintColor:'white'}} />
